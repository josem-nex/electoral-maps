# etiquetas-municipios Specification

## Purpose

Sistema de visualización de nombres municipales en el mapa electoral, mostrando tooltips interactivos al pasar el cursor sobre cada municipio cuando se navega a nivel departamental.
